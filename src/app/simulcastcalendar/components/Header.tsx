        ...
        <div className="flex items-center h-16">
          ...
          <nav className="hidden md:flex space-x-4 ml-auto">
            ...
            <a href="/pt-br/random/anime?random_ref=topbar" className="text-gray-700 hover:text-orange-500 px-3 py-2 flex flex-col items-center">
              ...
              <span className="text-xs">Aleatório</span>
            </a>
              ...
              {isDropdownOpen && userProfile && (
                <div className={styles.dropdownMenu}>
                  <ul>
                    ...
                    <li className={styles.hasNum}>
                      <a href="/notifications" itemProp="url">
                        <div className="clearfix cf">
                          <span className="left">Notificações</span>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a id="header_account_settings" href="/acct" itemProp="url">
                        Configurações
                      </a>
                    </li>

                    <li>
                      <a href="http://www.crunchyroll.com/orderstatus" itemProp="url">
