...
const LatestNews = () => {
  ...
  return (
    <div className="relative w-full">
      <div
        className="w-full border-b-4 mb-3 border-[#F47521] flex justify-between items-center"
      >
        <h1 className="text-3xl font-weight-700 text-white mb-2">
          Últimas Notícias
        </h1>
      </div>
      
      <div className={`flex flex-col gap-4 ${isDark ? "bg-[#2B2D32]" : "bg-[#F0EDE7]"} px-4 py-2`}>
        ...
        <div className="text-center mt-4">
          <Link
            href="/news/latest"
            className="text-[#008382] border border-[#008382] px-4 py-2 hover:bg-[#008382] hover:text-[#000] inline-block"
          >
            Todas as Notícias
          </Link>
        </div>
