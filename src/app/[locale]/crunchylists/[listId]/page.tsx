            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
              ...
              <div className={styles.settings}>
                <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                  <span className={`${styles.settingDiv} ${isDropdownOpen ? styles.active : ''}`}>
                ...
                {isDropdownOpen && (
                  <div className={styles.dropdownMenu}>
                    <button onClick={() => { setIsModalOpen(true); setIsDropdownOpen(false); }}>{t('editListName')}</button>
                    <button onClick={() => { handleDelete(); setIsDropdownOpen(false); }}>{t('deleteList')}</button>
                  </div>
                )}
              </div>
            </div>
