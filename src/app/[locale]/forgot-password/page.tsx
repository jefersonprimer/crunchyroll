            ...
            <div className="flex flex-col gap-6">
              <form onSubmit={handleSubmit}>
                ...
                <div className="relative">
                  ...
                  <label
                    htmlFor="email"
                    className="absolute left-3 top-1/2 -translate-y-1/2 text-[#888] transition-all duration-300 pointer-events-none peer-focus:top-0 peer-focus:left-2 peer-focus:text-xs peer-focus:px-1 peer-focus:bg-[#2a2a2a] peer-focus:text-[#f47521] peer-[&:not(:placeholder-shown)]:top-0 peer-[&:not(:placeholder-shown)]:left-2 peer-[&:not(:placeholder-shown)]:text-xs peer-[&:not(:placeholder-shown)]:px-1 peer-[&:not(:placeholder-shown)]:bg-[#2a2a2a] peer-[&:not(:placeholder-shown)]:text-[#f47521]"
                  >
                    Email
                  </label>
                </div>
