...
const FilterableHeader: React.FC = () => {
  ...
  return (
    <div className="flex justify-between items-center gap-4 w-full max-w-[1050px] h-[44px] mb-2 px-2 mx-auto">
      <div className="flex-1 min-w-0">
        {showSkeleton ? (
          <div className="h-10 w-88 bg-[#141519] animate-pulse" />
        ) : (
          <h2 className="text-[#FFFFFF] text-[1.25rem] font-weight-700 truncate">{t('sortOptions.mostRecentUpdate')}</h2>
        )}
      </div>
              ...
              <div className="relative">
                <div className="dropdown">
                  ...
                  >
                    ...
                    <span className="text-sm font-medium uppercase">{t('buttons.filter')}</span>
                  </div>
