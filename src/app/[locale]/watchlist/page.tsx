...
const WatchlistPage = async (props: { params: { locale: string } }) => {
          ...
          <div className="flex justify-center items-center h-full">
            <div className="w-full h-auto mx-auto">
              <div className="flex flex-col items-center w-full">
                <div className="text-center w-[1050px] h-[152px]">
                  <div className="text-center w-[1050px] h-[62px]">
                  ...
                  <div className="flex justify-center gap-5 border-b-2 border-gray-600 w-[1058px] mx-auto mb-1">
