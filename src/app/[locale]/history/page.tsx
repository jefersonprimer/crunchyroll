...
const History = async (props: { params: { locale: string } }) => {
                ...
                <div className="text-center w-[1050px] h-[152px]">
                  <div className="text-center w-[1050px] h-[62px]">
                    <h1 className="text-2xl mb-6 gap-2 flex items-center justify-center">
                      ...
                      <span className="text-[1.6rem] font-medium">{t('History.mylists')}</span>
                    </h1>
                  </div>
                  <div className="flex justify-center gap-5 border-b-2 border-gray-600 w-[1058px] mx-auto mb-1">
                    <div className="flex gap-4">
                      <div role="tablist" className="flex">
                        ...
                        >
                          <span className="uppercase text-[0.875rem] font-extrabold">{t('History.queue')}</span>
                        </Link>
                        ...
                        <Link
                          ...
                          className="flex justify-center items-center text-[#A0A0A0] no-underline px-[2.5rem] py-[1.5rem] text-sm cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#141519] hover:text-[#FFFFFF]"
                        >
                          <span className="uppercase text-[0.875rem] font-extrabold">{t('History.crunchylists')}</span>
                        </Link>
                        ...
                        >
                          <span className="uppercase text-[0.875rem] font-extrabold">{t('History.history')}</span>
                        </Link>
                      </div>
                    </div>
                  </div>
