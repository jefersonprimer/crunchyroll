        ...
        {userProfile && (
          <Link href="/profile">
            <div className={styles.profileInfo}>
              ...
              />
              <span className={styles.profileName}>{userProfile.display_name}</span>
              <svg
        ...
        <div className={styles.modalBody}>
          ...
          <div className={styles.borderBottom}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                height="24"
              >
                <path d="M22 17v2H6v-2h16zM3 17c.552 0 1 .448 1 1s-.448 1-1 1-1-.448-1-1 .448-1 1-1zm19-6v2H6v-2h16zM3 11c.552 0 1 .448 1 1s-.448 1-1 1-1-.448-1-1 .448-1 1-1zm19-6v2H6V5h16zM3 5c.552 0 1 .448 1 1s-.448 1-1 1-1-.448-1-1 .448-1 1-1z"></path></svg>
              <span>{t('crunchyLists')}</span>
            </Link>
            <Link href="/watchlist" className={styles.menuItem}>
            <svg xmlns="http://www.w3.org/2000/svg"
