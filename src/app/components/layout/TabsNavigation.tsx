              ...
              <div className="flex gap-4">
                <div role="tablist" className="flex">
                  <Link
                    ...
                    className={`flex justify-center items-center no-underline px-[2.5rem] py-[1.5rem] text-sm cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#141519] ${
                      selectedTab === 'fila' ? 'text-white border-b-3 border-[#FF640A]' : 'text-[#A0A0A0] hover:text-white active:text-white'
                    }`}
                  >
                    <span className="uppercase text-[0.875rem] font-extrabold">{labels.fila}</span>
                  </Link>
                  <Link
                  ...
                  >
                    <span className="uppercase text-[0.875rem] font-extrabold">{labels.crunchylists}</span>
                  </Link>
                  <Link
                    href={`/${locale}/history`}
                    className={`flex justify-center items-center no-underline px-[2.5rem] py-[1.5rem] text-sm cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#141519] ${
                  ...
                  >
                    <span className="uppercase text-[0.875rem] font-extrabold">{labels.historico}</span>
                  </Link>
                </div>
              </div>
            </div>
