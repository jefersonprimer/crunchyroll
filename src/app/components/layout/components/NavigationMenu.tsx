...
export default function NavigationMenu() {
  ...
  return (
    <div className="flex items-center m-0 p-0 gap-0 h-[60px]">
      <Link href={`/${locale}/videos/new`} className="relative h-full">
        <span 
          className="font-medium text-[16px] leading-[1.5rem] flex items-center  text-[#DADADA] no-underline cursor-pointer px-[15px] h-full whitespace-nowrap hover:text-[#ffffff] hover:bg-[#141519]">
          {t('new')}
        </span>
      </Link>
      <Link href={`/${locale}/videos/popular`} className="relative h-full">
        <span 
          className="font-medium text-[16px] leading-[1.5rem] flex items-center  text-[#DADADA] no-underline cursor-pointer px-[15px] h-full whitespace-nowrap hover:text-[#ffffff] hover:bg-[#141519]">
          {t('popular')}
        </span>
      </Link>
      <Link href={`/${locale}/simulcasts/seasons/spring-2025`} className="relative h-full">
        <span 
          className="font-medium text-[16px] leading-[1.5rem] flex items-center  text-[#DADADA] no-underline cursor-pointer px-[15px] h-full whitespace-nowrap hover:text-[#ffffff] hover:bg-[#141519]">
          {t('simulcasts')}
        </span>
      ...
      <div className="relative h-full">
        <div
          ref={buttonRef}
          className={`relative z-[1001] font-medium  text-[16px] leading-[1.5rem] flex items-center  text-[#DADADA] no-underline cursor-pointer px-[15px] h-full whitespace-nowrap hover:text-[#ffffff] hover:bg-[#141519] 
      ...
      <div className="w-[1px] h-[20px] bg-[#4A4E58] my-0 mx-[4px]" />
        <Link href={`/${locale}/games`} className="relative h-full">
          <span 
            className="font-medium text-[16px] leading-[1.5rem] flex items-center  text-[#DADADA] no-underline cursor-pointer px-[15px] h-full whitespace-nowrap hover:text-[#ffffff] hover:bg-[#141519]">
            {t('games')}
          </span>
        </Link>
        {/* <Link href={`/${locale}/store`} className="relative h-full">
          <span
            className="font-medium text-[16px] leading-[1.5rem] flex items-center  text-[#DADADA] no-underline cursor-pointer px-[15px] h-full whitespace-nowrap hover:text-[#ffffff] hover:bg-[#141519]">
            {t('store')}
          </span>
