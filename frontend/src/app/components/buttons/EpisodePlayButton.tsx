...
const EpisodePlayButton: React.FC<EpisodePlayButtonProps> = ({ episode, className = '' }) => {
  ...
  return episode ? (
    <Link 
      ...
      className={`flex items-center gap-1 py-2 px-4 h-full bg-[#ff640a] text-black text-sm font-bold uppercase transition-colors duration-300 ease-in-out hover:bg-[#e65c09] ${className}`}
    >
    ...
    <div className={`flex items-center h-full bg-[#ff640a] text-black text-sm font-bold uppercase cursor-not-allowed opacity-50 ${className}`}>
