          ...
          <div className="flex flex-col max-w-[1050px] mx-auto py-5">
            <div className="flex flex-col items-start mb-5 w-full no-underline">
              <Link href={`/${locale}/crunchylists`}>
                <div>
                  <span className="flex items-center text-white no-underline mb-5 cursor-pointer">
                    <svg
              ...
              <div className="flex items-center justify-center gap-5 w-full sm:w-auto">
                <div ref={inputContainerRef} className="relative w-[300px]">
                  <input
                    ...
                    disabled
                    className="w-full p-2.5 border-b border-[#59595B] bg-black text-white mb-2.5 focus:outline-none focus:border-[#ff640a] opacity-50 cursor-not-allowed"
      ...
      <div>
        <div className="flex flex-col max-w-[1050px] mx-auto py-5">
          <div className="flex flex-col items-start mb-5 w-full no-underline">
            ...
            <h1 className="text-2xl text-white mb-5">{currentList.name}</h1>
            <div className="flex flex-col sm:flex-row justify-between items-center w-full gap-4 no-underline">
              <div className="flex items-center justify-center gap-5 w-full sm:w-auto">
                <div ref={inputContainerRef} className="relative w-[300px]">
                  <input
                    ...
                    onFocus={() => setIsInputFocused(true)}
                    className="w-full p-2.5 border-b border-[#59595B] bg-black text-white mb-2.5 focus:outline-none focus:border-[#ff640a]"
                    aria-label={t('searchPlaceholder')}
                  />
                  <SearchModal
              ...
              <div className="relative">
                <button onClick={() => setIsDropdownOpen(!isDropdownOpen)} aria-label={t('settings')}>
                  <span className={`flex items-center cursor-pointer text-white py-2 px-4 ${isDropdownOpen ? 'bg-[#23252B]' : ''} hover:bg-[#23252B] active:bg-[#23252B] transition-all duration-200`}>
                ...
                {isDropdownOpen && (
                  <div className="absolute top-full right-0 bg-[#23252B] py-3 z-[1000] w-[200px] h-[108px] transition-all duration-200 shadow-lg">
                    <button 
                      onClick={() => { setIsModalOpen(true); setIsDropdownOpen(false); }}
                      className="block w-full py-2.5 px-4 text-left bg-none border-none text-[#A0A0A0] cursor-pointer hover:text-white hover:bg-[#141519] transition-all duration-200"
          ...
          {animesLoading && (
            <div className="text-white text-center py-4">Carregando animes...</div>
          )}
          {animesError && (
