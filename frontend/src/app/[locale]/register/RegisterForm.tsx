...
const RegisterForm = ({ locale }: Props) => {
    ...
    <div className="p-5 shadow-md w-[540px] text-center">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input
                ...
                required
                className="w-full text-white bg-transparent border-b-2 border-[#ccc]  py-2 text-base outline-none transition-colors focus:border-[#ff640a] peer placeholder-transparent"
                placeholder=" "
            />
            <label
                htmlFor="email"
                className="absolute left-0 top-3 text-[#aaa] text-base transition-all duration-200 pointer-events-none peer-focus:-top-3.5 peer-focus:left-0 peer-focus:text-xs peer-focus:text-[#ff640a] peer-[&:not(:placeholder-shown)]:-top-3.5 peer-[&:not(:placeholder-shown)]:left-2 peer-[&:not(:placeholder-shown)]:text-xs peer-[&:not(:placeholder-shown)]:text-[#ff640a]"
            >
                Email
            </label>
            </div>
            ...
            <button
                type="button"
                className="absolute right-2 top-3 bg-transparent border-none font-bold text-[#666] cursor-pointer text-xs transition-colors hover:text-[#333]"
