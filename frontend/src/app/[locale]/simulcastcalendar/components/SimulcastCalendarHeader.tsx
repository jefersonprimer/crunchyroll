        ...
        <div className="flex space-x-0.5 mb-6">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <span className="font-normal text-[0.6875rem] uppercase">{t('releaseCalendars')}</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="font-normal text-[0.6875rem] uppercase">
              {t('spring2025Lineup')}
            </div>
          </a>
        </div>
        ...
        <form id="filter_toggle_form" className="flex justify-center space-x-8" action="" method="get">
          <label className="flex items-center space-x-2 cursor-pointer">
            <input 
              ...
              value="premium"
            />
            <span className="font-normal text-[#000] text-[0.6875rem]">
